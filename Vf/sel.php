...
<div class="section padding_layout_1">
  <div class="container">
    <?php
        ...
        $requete="SELECT * FROM T_SELECTION_SELE;";
        $result1 = $mysqli->query($requete);
        ...
        else //La requête s’est bien exécutée (<=> couleur verte dans phpmyadmin)
        {
             ...
             echo ("<table class= 'table-bordered table-dark'>");
             echo ("<tr>");
             echo ("<th>"); echo ("TITRE"); echo ("</th>");
             echo ("<th>"); echo("Introduction"); echo ("</th>");
             echo ("<th>"); echo("Date"); echo ("</th>");
             echo ("<th>"); echo("Pseudo"); echo ("</th>");
             echo ("<th>"); echo("Lien"); echo ("</th>");
             echo("</tr>");    
                
            while ($selection = $result1->fetch_assoc())
                {
                        echo("<tr>");
                        echo("<td>".$selection['SELE_TITRE']."</td>");
                        echo("<td>".$selection['SELE_INTROTEXTE']."</td>");
                        echo("<td>".$selection['SELE_DATE']."</td>");
                        echo("<td>".$selection['CUR_ID']."</td>");

                        $req="SELECT ELE_ID FROM TJ_RELIE_REL WHERE SELE_ID=".$selection['SELE_ID']." and ELE_ID > 0 LIMIT 1;";
                        ...
                        echo("<td><a href='affichagesel.php?SELE_ID=".$selection['SELE_ID']."&ELE_ID=".$element['ELE_ID']."'><i class='fa fa-eye' style='padding-left:5px; color:white; font-size: 16px; text-align:center;''></i></a></td>");
