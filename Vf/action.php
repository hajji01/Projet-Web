...
<header id="default_header" class="header_style_1">
  ...
  <div class="header_top">
    <div class="container">
      <?php
    if ($_POST['pseudo']&&$_POST['mdp']&&$_POST['mdp2']&&$_POST['nom']&&$_POST['prenom']&&$_POST['email']) //tester la presence des infos dans les champs de saisie
      {
        if (strcmp($_POST['mdp'],$_POST['mdp2'])==0)//verification de la confirmation de mdp
        {
          ...
          if ($mysqli->connect_errno)
          ...
          else
            {
              ...
              <div class="title"><h6>Connexion de base réussie !</h6></div></div></div>';
            }
          if (!$mysqli->set_charset("utf8")) //// Instructions PHP à ajouter pour l'encodage utf8 du jeu de caractères
          {
             printf("Pb de chargement du jeu de car. utf8 : %s\n", $mysqli->error);
             exit();
          }
          $sql="INSERT INTO T_COMPTEUTILISATEUR_CUR VALUES('" .$id. "',md5('" .$mdp. "'));";
          ...
          if ($result3 == false) //Erreur lors de l’exécution de la requête
          ...
          else //Requête réussie
            {
              ...
              $sql2="INSERT INTO T_PROFILUTILISATEUR_PUR (`CUR_ID`,`PUR_NOM`,`PUR_PRENOM`,`PUR_EMAIL`,`PUR_STATUT`,`PUR_VALIDITE`,`PUR_DATECREATION`) VALUES('" .$id. "','" .$nom. "','" .$prenom. "','" .$email. "','R','A',CURDATE());";
              ...
              if ($result4 == false) 
                {
                   ...
                   $sql3="DELETE FROM T_COMPTEUTILISATEUR_CUR where CUR_ID ='" .$id. "';";
                   $result5 = $mysqli->query($sql3);
                    if($result5 == false)
                    ...
                    else
                      {
                        echo '<div id="page-wrapper">
                        <div id="welcome" class="container">
                        <div class="title"><h2>Votre a bien été supprimé</h2></div></div></div>';
                        echo '<div id="header" class="container"><div id=menu><ul><li class="active"><a href="http://obiwan2.univ-brest.fr/licence/lic208/v1/inscription.php" accesskey="2">Retour</a></li></ul></div></div>';
              ...
              else //Requête réussie
                {
                  ...
                  <div id="welcome" class="container">
                  <div class="title"><h2>Welcome Mr,M '.$nom.' '.$prenom.' sur notre boutique</h2></div></div></div>';
                  echo '<div id="header" class="container"><div id=menu><ul><li class="active"><a href="http://obiwan2.univ-brest.fr/licence/lic208/v1/index.php" accesskey="2">Retour</a></li></ul></div></div>';
        ...
        else 
          {
            echo '<div id="page-wrapper">
            <div id="welcome" class="container">
            <div class="title"><h2>Mot de passe incorrect</h2></div></div></div>';
            echo '<div id="header" class="container"><div id=menu><ul><li class="active"><a href="http://obiwan2.univ-brest.fr/licence/lic208/v1/inscription.php" accesskey="2">Retour</a></li></ul></div></div>';
          }
        ...
        {
          echo '<a  href="inscription.php">Veuillez remplissez les champs</a>';
        }
